                ...
                >
                    <div class="my-auto">
                        ...
                        <v-alert
                            ...
                            density="compact"
                        >
                            Token reset password tidak valid atau tidak
                            ditemukan.
                        </v-alert>
                        ...
                        <v-form v-else @submit.prevent="handleReset">
                            ...
                            <v-btn
                                ...
                                rounded="lg"
                                elevation="0"
                                class="font-weight-bold text-white text-body-1 mt-10"
                                style="
                                    text-transform: none;
...
async function handleReset() {
    ...
    try {
        const response = await axios.post("/api/v1/admin/auth/reset-password", {
            token: token.value,
