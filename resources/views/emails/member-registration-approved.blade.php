...
@section('title', 'Registrasi Kemitraan Disetujui')
@section('heading', 'Registrasi Kemitraan Disetujui')

@section('content')
    <p style="font-size:16px;line-height:1.6;margin:0 0 18px;">Halo <strong>{{ $memberName }}</strong>,</p>
    <p style="font-size:15px;line-height:1.7;margin:0 0 24px;">Selamat, berdasarkan hasil verifikasi, registrasi kemitraan DNY Skincare Anda telah disetujui dan akun Anda telah aktif.</p>
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#fff4f6;border:1px solid #f5ccd5;border-radius:12px;margin-bottom:26px;">
        ...
        <tr>
            <td style="padding:14px 20px;border-bottom:1px solid #f5ccd5;color:#775e64;font-size:13px;">Upline</td>
            <td align="right" style="padding:14px 20px;border-bottom:1px solid #f5ccd5;font-size:15px;font-weight:700;">{{ $sponsorName }}</td>
        </tr>
        <tr>
            <td style="padding:14px 20px;border-bottom:1px solid #f5ccd5;color:#775e64;font-size:13px;">Status</td>
            <td align="right" style="padding:14px 20px;border-bottom:1px solid #f5ccd5;font-size:15px;font-weight:700;color:#16834b;">AKTIF</td>
        </tr>
        <tr>
    ...
    <p style="font-size:13px;line-height:1.6;color:#775e64;margin:0 0 10px;">Silakan masuk menggunakan akun di atas. Demi keamanan, segera ubah password sementara setelah berhasil masuk.</p>
    <p style="font-size:13px;line-height:1.6;color:#775e64;margin:0;">Selamat bergabung dan berkembang bersama DNY Skincare.</p>
@endsection
