...
<head>
    ...
    <title>DNY Telescope</title>

    <!-- Style sheets-->
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=figtree:300,400,500,600" rel="stylesheet" />
    <link href="{{ asset('css/telescope-brand.css') }}" rel="stylesheet">
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            <router-link to="/" class="logo d-flex align-items-center">
                <img src="{{ asset('favicon.ico') }}" alt="DNY Skincare" class="dny-telescope-logo">

                <h4 class="mb-0 ml-3"><strong>DNY</strong> Telescope</h4>
            </router-link>
